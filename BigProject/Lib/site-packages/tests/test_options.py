...
class TestOptions(unittest.TestCase):
    ...
    def test_eq(self):
        self.assertEqual(
            Options("unordered-list-item", "li"), Options("unordered-list-item", "li")
        )

    def test_not_eq(self):
        self.assertNotEqual(
            Options("unordered-list-item", "li"), Options("unordered-list-item", "p")
        )

    def test_for_block_full(self):
        self.assertEqual(
            Options.for_block({"unordered-list-item": "li"}, "unordered-list-item"),
    ...
    def test_for_block_uses_fallback(self):
        self.assertEqual(
            Options.for_block({"header-one": "h1", "fallback": "div"}, "header-two"),
    ...
    def test_for_style_full(self):
        self.assertEqual(
            Options.for_style({"ITALIC": "em"}, "ITALIC"), Options("ITALIC", "em")
        )
    ...
    def test_for_style_uses_fallback(self):
        self.assertEqual(
            Options.for_style({"BOLD": "strong", "FALLBACK": "span"}, "CODE"),
            Options("CODE", "span"),
        )
    ...
    def test_for_entity_full(self):
        self.assertEqual(
            Options.for_entity({"HORIZONTAL_RULE": "hr"}, "HORIZONTAL_RULE"),
            Options("HORIZONTAL_RULE", "hr"),
        )
    ...
    def test_for_entity_uses_fallback(self):
        self.assertEqual(
            Options.for_entity({"HORIZONTAL_RULE": "hr", "FALLBACK": "div"}, "TEST"),
            Options("TEST", "div"),
        )
