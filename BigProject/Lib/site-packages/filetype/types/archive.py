...
class Epub(Type):
    ...
    def __init__(self):
        super(Epub, self).__init__(mime=Epub.MIME, extension=Epub.EXTENSION)
...
class Zip(Type):
    ...
    def __init__(self):
        super(Zip, self).__init__(mime=Zip.MIME, extension=Zip.EXTENSION)
...
class Tar(Type):
    ...
    def __init__(self):
        super(Tar, self).__init__(mime=Tar.MIME, extension=Tar.EXTENSION)
...
class Rar(Type):
    ...
    def __init__(self):
        super(Rar, self).__init__(mime=Rar.MIME, extension=Rar.EXTENSION)
...
class Gz(Type):
    ...
    def __init__(self):
        super(Gz, self).__init__(mime=Gz.MIME, extension=Gz.EXTENSION)
...
class Bz2(Type):
    ...
    def __init__(self):
        super(Bz2, self).__init__(mime=Bz2.MIME, extension=Bz2.EXTENSION)
...
class SevenZ(Type):
    ...
    def __init__(self):
        super(SevenZ, self).__init__(mime=SevenZ.MIME, extension=SevenZ.EXTENSION)
...
class Pdf(Type):
    ...
    def __init__(self):
        super(Pdf, self).__init__(mime=Pdf.MIME, extension=Pdf.EXTENSION)
...
class Swf(Type):
    ...
    def __init__(self):
        super(Swf, self).__init__(mime=Swf.MIME, extension=Swf.EXTENSION)

    def match(self, buf):
        return (
            len(buf) > 2
            and (buf[0] == 0x43 or buf[0] == 0x46)
            and buf[1] == 0x57
            and buf[2] == 0x53
        )
...
class Rtf(Type):
    ...
    def __init__(self):
        super(Rtf, self).__init__(mime=Rtf.MIME, extension=Rtf.EXTENSION)
...
class Nes(Type):
    ...
    def __init__(self):
        super(Nes, self).__init__(mime=Nes.MIME, extension=Nes.EXTENSION)
...
class Crx(Type):
    ...
    def __init__(self):
        super(Crx, self).__init__(mime=Crx.MIME, extension=Crx.EXTENSION)
...
class Cab(Type):
    ...
    def __init__(self):
        super(Cab, self).__init__(mime=Cab.MIME, extension=Cab.EXTENSION)
...
class Eot(Type):
    ...
    def __init__(self):
        super(Eot, self).__init__(mime=Eot.MIME, extension=Eot.EXTENSION)
...
class Ps(Type):
    ...
    def __init__(self):
        super(Ps, self).__init__(mime=Ps.MIME, extension=Ps.EXTENSION)
...
class Xz(Type):
    ...
    def __init__(self):
        super(Xz, self).__init__(mime=Xz.MIME, extension=Xz.EXTENSION)
...
class Deb(Type):
    ...
    def __init__(self):
        super(Deb, self).__init__(mime=Deb.MIME, extension=Deb.EXTENSION)
...
class Ar(Type):
    ...
    def __init__(self):
        super(Ar, self).__init__(mime=Ar.MIME, extension=Ar.EXTENSION)
...
class Z(Type):
    ...
    def __init__(self):
        super(Z, self).__init__(mime=Z.MIME, extension=Z.EXTENSION)
...
class Lzop(Type):
    ...
    def __init__(self):
        super(Lzop, self).__init__(mime=Lzop.MIME, extension=Lzop.EXTENSION)
...
class Lz(Type):
    ...
    def __init__(self):
        super(Lz, self).__init__(mime=Lz.MIME, extension=Lz.EXTENSION)
...
class Lz4(Type):
    ...
    def __init__(self):
        super(Lz4, self).__init__(mime=Lz4.MIME, extension=Lz4.EXTENSION)
...
class Br(Type):
    ...
    def __init__(self):
        super(Br, self).__init__(mime=Br.MIME, extension=Br.EXTENSION)
...
class Rpm(Type):
    ...
    def __init__(self):
        super(Rpm, self).__init__(mime=Rpm.MIME, extension=Rpm.EXTENSION)
...
class Zstd(Type):
    ...
    def __init__(self):
        super(Zstd, self).__init__(mime=Zstd.MIME, extension=Zstd.EXTENSION)
